...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1101724431').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001583148608'))
# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001731083874').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001318129232') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001820614679')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002291177292').split()]  # For Multiple Id Use One Space Between Each.
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://AllMoviesLinkBot:AllMoviesLinkBot@allmovieslinkbot.h03wb.mongodb.net/?retryWrites=true&w=majority&appName=AllMoviesLinkBot")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "AllMoviesLinkBot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'AllMoviesLinkBot')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://telegra.ph/Payment-For-Premium-06-10') # payment code picture url.
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'd93350ce30344556f6f4d3026c936ad5c27276b0')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/wwwmovieslink/7')
# If You Fill Second Shortner Then Bot Attach Both First And Second Shortner And Use It For Verify.
VERIFY_SECOND_SHORTNER = bool(environ.get('VERIFY_SECOND_SHORTNER', False))
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'kingurl.in')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', 'd93350ce30344556f6f4d3026c936ad5c27276b0')
# Shortlink Info
SHORTLINK_MODE = bool(environ.get('SHORTLINK_MODE', True)) # Set True Or False
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'kingurl.in')
SHORTLINK_API = environ.get('SHORTLINK_API', 'd93350ce30344556f6f4d3026c936ad5c27276b0')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/wwwmovieslink/7') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
# Others
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://stupid-sonny-allmoviesstore-8446e82d.koyeb.app/")
